...
public class Whiteskye extends MilitaryBase{
    ...
    public void apply()
    {
		...
		//market.getStability().modifyFlat("Whiteskye base", IMPROVE_STABILITY_BONUS, getNameForModifier() );
   ...
   @Override
    public CampaignFleetAPI spawnFleet(RouteManager.RouteData route)
    {
        ...
        CampaignFleetAPI fleet = createPatrol(type, "Whitesky", route, market, null, random);// generates the fleet
